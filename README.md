...
Below you'll find all the parameters with their defaults (they can also be found in [DoctrineORMServiceProvider::setOrmDefaults](https://github.com/fredjuvaux/silex-orm-provider/blob/master/lib/ORM/Provider/DoctrineORMServiceProvider.php#L48-68)).
